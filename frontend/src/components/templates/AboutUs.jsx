      ...
      <div className="flex flex-col md:flex-row gap-0 lg:gap-20">
        <div className="w-100% md:w-1/2 mb-10">
          ...
          <p className="text-lg mt-10">
            ...
            nemo alias deleniti obcaecati asperiores perspiciatis fugiat autem.
            Blanditiis iusto eos, vitae veniam laboriosam esse voluptatem
            voluptatum consectetur aliquid id quod!
          </p>
        </div>
